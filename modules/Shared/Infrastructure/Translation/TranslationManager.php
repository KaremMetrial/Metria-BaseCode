...
class TranslationManager extends Manager
{
    ...
    public function driver($driver = null)
    {
        ...
        if (! $provider instanceof \Modules\Shared\Infrastructure\Translation\Providers\CircuitBreakerProvider) {
            ...
            $provider = new \Modules\Shared\Infrastructure\Translation\Providers\CircuitBreakerProvider($provider, $threshold, $cooldown);
        }
